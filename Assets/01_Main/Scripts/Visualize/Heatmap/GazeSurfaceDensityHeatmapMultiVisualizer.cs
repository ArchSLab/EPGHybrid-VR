...
/// <summary>
/// Multi-participant continuous surface-density heatmap visualizer.
///
...
/// It can coexist with the old splat visualizer because the class name is different.
/// </summary>
public class GazeSurfaceDensityHeatmapMultiVisualizer : MonoBehaviour
{
    ...
    private void DrawPanel(int windowID)
    {
        ...
        GUILayout.Label("Multi-Participant Surface Density Heatmap", GUILayout.Width(315));
